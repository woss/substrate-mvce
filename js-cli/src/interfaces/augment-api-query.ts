...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    poe: {
      [index: string]: QueryableStorageEntry<ApiType>;
      rules: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<ITuple<[Bytes, Bytes, AccountId, BlockNumber]>>> & QueryableStorageEntry<ApiType>;
      rulesNew: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<ITuple<[Bytes, Rule, AccountId, BlockNumber]>>> & QueryableStorageEntry<ApiType>;
    };
