...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    poe: {
       ...
       **/
      createRule: AugmentedSubmittable<(ruleId: Bytes | string | Uint8Array, payload: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      createRuleNew: AugmentedSubmittable<(ruleId: Bytes | string | Uint8Array, payload: Rule | { description?: any; creator?: any; version?: any; forWhat?: any; parent?: any; buildParams?: any; ops?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    sudo: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
